			...
			<div className={styles.containerInfo1}>
				<div className={classes.container}>
					<Button onClick={handleClick} className={styles.btn}>
						<HiMenu className={classes.emoticon} />
					</Button>
					<img
						src={Everylogopf}
						alt='img'
				...
				>
					...
					<Link to='/products/all'>
						<MenuItem className={classes.menuItem}>
							{' '}
							<ImHome className={classes.emoticon} /> Home
						</MenuItem>
					</Link>
					...
					>
						{' '}
						<FaPencilAlt className={classes.emoticon} /> Edit my profile
					</MenuItem>
					<MenuItem className={classes.menuItem} onClick={logout}>
						<FiLogOut className={classes.emoticon} /> Logout
					</MenuItem>
					...
					>
						<MenuItem className={classes.menuItem}>
							{' '}
							<IoLogoVercel className={classes.emoticon} /> Link deploy
						</MenuItem>
					</a>
				</Menu>
			</div>
