...
export const MyShopping = () => {
    ...
    return (
        <div className={styles.contClient}>
            ...
            {
                complete?<ProductComplete Transactions={user.Transactions} user={user}/>: process? <ProductProcess Transactions={user.Transactions} />: cancel? <ProductCancel Transactions={user.Transactions} />: null
            }
        </div>
    )
}
