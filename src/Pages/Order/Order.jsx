...
export default function Order() {
    ...
    const [direction,setDirection]=useState({country:"",city:"",address:""});

    const handleChangeDirection= (e)=>{
      setDirection({...direction,[e.target.name]:e.target.value});
    }
    useEffect(()=>{
      setDirection({country:user.country,city:user.city,address:user.address})
    },[user])
  return (
    <div>
                ...
                <div>
                  <div className={style.direction}>
                    <h2>Shipping Address</h2>
                      <form autoComplete="new-password" className={style.containerForm} onChange={handleChangeDirection}>
                        <div>
                          <p>Country</p>
                          <input autoComplete="none" type="text" id="country" name="country" defaultValue={direction.country}/>
                        </div>
                        <div>
                          <p>City</p>
                          <input autoComplete="none" type="text" id="city" name="city" defaultValue={direction.city}/>
                        </div>
                        <div>
                          <p>Address</p>
                          <input autoComplete="none" type="text" id="address" name="address" defaultValue={direction.address}/>
                        </div>
                        <input 
                          type="text" 
                          autoComplete="on" 
